window.onload=function(){
	...
	function imgthree(){
		...
		var a=setInterval(function (){
			option.series[0].data[0].value = ((Math.random()*10)+40).toFixed(2);
			option.series[1].data[0].value = ((Math.random()*1)+1.5).toFixed(2);
			option.series[2].data[0].value = ((Math.random()*1)+0.5).toFixed(2);
			option.series[3].data[0].value = ((Math.random()*1)+0.5).toFixed(2);
			myChart.setOption(option);
		},1000)
